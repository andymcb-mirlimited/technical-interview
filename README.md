...
There is a *Postman* collection at [Interviewer.postman_collection.json](https://github.com/andymcb-mirlimited/technical-interview/blob/master/Interviewer.postman_collection.json) that you can use to test your API implementation.

### Technology stack

- use [Ratpack](https://ratpack.io) as Java server side framework and [Redis](https://redis.io/) as the datastore.
- do not use spring DI or spring components, use [Guice](https://ratpack.io/manual/current/guice.html) if DI is needed.
